...
const subjects: Record<string, Subject> = {
    english: {
        name: "English",
        description: "Master English language skills for HESI",
        image: "/english.jpg",
        topics: [
          {
  ...
  math: {
    name: "Math",
    description: "Master Math language skills for HESI",
    image: "/math.jpg",
    topics: [
      {
  ...
  science: {
    name: "Science",
    description: "Master Science language skills for HESI",
    image: "/Science.jpg",
    topics: [
      {
  ...
  reading: {
    name: "Reading",
    description: "Master Reading language skills for HESI",
    image: "/reading.jpg",
    topics: [
      {
  ...
  return (
    ...
    <div className="container mx-auto pt-8 pb-12">
      <CourseBanner
        ...
        image={subject.image}
      />
      <SubjectContent subject={params.subject} topics={subject.topics} testType="hesi"/>
    </div>
