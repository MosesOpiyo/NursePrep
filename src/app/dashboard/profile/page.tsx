    ...
    <div className="settings-container flex flex-col gap-4">
      ...
      <div className="settings-header p-8 flex flex-col gap-2">
        ...
        <TabsList className="tabs-list p-8 w-full">
          <TabsTrigger className="rounded-none tabs-trigger" value="profile">Profile Info</TabsTrigger>
          <TabsTrigger className="rounded-none tabs-trigger" value="subscription">Subscription & Billing</TabsTrigger>
          <TabsTrigger className="rounded-none tabs-trigger" value="notification">Notifications & Preferences</TabsTrigger>
          <TabsTrigger className="rounded-none tabs-trigger" value="security">Account Security</TabsTrigger>
          <TabsTrigger className="rounded-none tabs-trigger" value="management">Account Management</TabsTrigger>
          <TabsTrigger className="rounded-none tabs-trigger" value="support">Support</TabsTrigger>
          <TabsTrigger className="rounded-none tabs-trigger" value="privacy">Privacy</TabsTrigger>
        </TabsList>
          ...
          <div className="profile-container w-full">
            ...
            <div className="profile-picture px-4 py-8 grid gap-12">
              ...
              <div className="picture-label flex flex-col justify-center gap-1">
                ...
                <p>Edit your profile picture. Your profile photo will be used on your profile and throughout the site.</p>
                </div>
            ...
            <div className="profile-details px-4 py-8 grid gap-12">
              ...
              <div className="details-label flex flex-col justify-center gap-1">
                ...
                <div className="label-text">
                <p>Edit your name and username. Your profile name and username will be used on your profile and throughout the site.</p>
                </div>
              ...
              <form className="flex flex-col items-center gap-8" onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <Button className="w-1/2 self-center" type="submit">Submit</Button>
